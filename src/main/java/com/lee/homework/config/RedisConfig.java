...
public class RedisConfig {
    ...
    public JedisCluster getJedisCluster() {
        ...
        // 9.创建JedisCluster对象
        // 也没有无参构造方法
        JedisCluster jedisCluster = new JedisCluster(hostAndPortSet, Integer.parseInt(redisProperties.getCommandTimeout()), Integer.parseInt(redisProperties.getMaxAttmpts()));
        // 10.返回jedisCluster对象
        return jedisCluster;
    }
